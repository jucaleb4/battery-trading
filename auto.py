...
cmd = f"python run.py --train_len 200000 --more_data --norm_obs --norm_rwd --daily_cost 100 --learning_rate 0.000918 --exploration_fraction 0.9685 --n_trials 10 --seed 0 --solar_coloc"
os.system(cmd)
